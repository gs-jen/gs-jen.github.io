...
contains:[n.SHEBANG({binary:"ruby"})].concat(E).concat(b).concat(o)}}})());hljs.registerLanguage("applescript",(()=>{"use strict";function e(e){
...
},...a],illegal:/\/\/|->|=>|\[\[/}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
subLanguage:"vbscript"}]})})());hljs.registerLanguage("ebnf",(()=>{"use strict";return e=>{
...
}].concat(n)}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("actionscript",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
illegal:/#/})})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("basic",(()=>{"use strict";return E=>({name:"BASIC",
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]})})());hljs.registerLanguage("xquery",(()=>{"use strict";return e=>({name:"XQuery",
...
subLanguage:"xquery"},"self"]}]})})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
...
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
...
begin:/\\./}]}]}}})());hljs.registerLanguage("bnf",(()=>{"use strict";return e=>({
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("dockerfile",(()=>{"use strict";return e=>({
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("dos",(()=>{"use strict";return e=>{
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("nsis",(()=>{"use strict";return e=>{const t={
